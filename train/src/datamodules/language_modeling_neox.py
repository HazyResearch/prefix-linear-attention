...
class NeoxLMDataModule(LightningDataModule):
    def __init__(self, 
        ...
        max_steps: int=None,
        num_workers=0,  # To debug the datasets class, set the number of workers to 1
        pin_memory=False,
    ...
    def prepare_data(self, stage=None):
        ...
        self.datasets = build_datasets(
            data_paths={
                "train": ["/home/data/pile//pile/pile_text_document"],
                "test": ["/home/data/pile//pile_test/pile_test_text_document"],
                "valid": ["/home/data/pile//pile_validation/pile_validation_text_document"],
            },
            num_samples={
    ...
    def _data_loader(self, dataset: Dataset, batch_size: int, shuffle: bool = False,
        ...
        return DataLoader(
            ...
            num_workers=0,  # Data is already in memory, we don't need many workers
            shuffle=shuffle,
            sampler=sampler,
    ...
    def __getitem__(self, idx):
        try:
            ...
            if self.use_mlm_loss:
                ...
                enc_labels = sample[:self.enc_length].copy()
                ...
                dec_labels = sample[self.enc_length:].copy()
